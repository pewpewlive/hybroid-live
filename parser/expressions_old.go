...
func (p *Parser) OLDexpression() ast.Node {
	return p.fn()
}

func (p *Parser) OLDfn() ast.Node {
...
func (p *Parser) OLDmultiComparison() ast.Node {
	expr := p.comparison()
...
func (p *Parser) OLDcomparison() ast.Node {
	expr := p.term()
...
func (p *Parser) OLDdetermineValueType(left ast.Node, right ast.Node) ast.PrimitiveValueType {
...
func (p *Parser) OLDterm() ast.Node {
	expr := p.factor()
...
func (p *Parser) OLDfactor() ast.Node {
	expr := p.concat()
...
func (p *Parser) OLDconcat() ast.Node {
	expr := p.unary()
...
func (p *Parser) OLDunary() ast.Node {
...
func (p *Parser) OLDentity() ast.Node {
...
func (p *Parser) OLDcall(caller ast.Node) ast.Node {
	hasGenerics := false
	args := []*ast.TypeExpr{}
...
func (p *Parser) OLDaccessorExprDepth2(ident *ast.Node) ast.Node {
...
func (p *Parser) OLDaccessorExpr(ident *ast.Node) (ast.Node, *ast.IdentifierExpr) {
	if ident == nil {
...
func (p *Parser) OLDmatchExpr() ast.Node {
...
func (p *Parser) OLDmacroCall() ast.Node {
...
func (p *Parser) OLDspawn() ast.Node {
...
func (p *Parser) OLDself() ast.Node {
...
func (p *Parser) OLDprimary(allowStruct bool) ast.Node {
...
func (p *Parser) OLDlist() ast.Node {
	token := p.peek(-1)
...
func (p *Parser) OLDparseMap() ast.Node {
	token := p.peek(-1)
...
func (p *Parser) OLDstructExpr() ast.Node {
...
func (p *Parser) OLDWrappedType() *ast.TypeExpr {
