...
var BuiltinEnv = &Environment{
	...
	Scope: Scope{
		...
		AliasTypes: map[string]*AliasType{
			"Mesh":     NewAliasType("Mesh", MeshType, true),
			"Meshes":   NewAliasType("Meshes", MeshesType, true),
			"Vertex":   NewAliasType("Vertex", NumberListVal.GetType(), true),
			"Vertexes": NewAliasType("Vertexes", VertexListVal.GetType(), true),
			"Segments": NewAliasType("Segments", VertexListVal.GetType(), true),
			"Segment":  NewAliasType("Segment", NumberListVal.GetType(), true),
			"Colors":   NewAliasType("Segments", NumberListVal.GetType(), true),
			...
			"Sound": NewAliasType("Sound", SoundType, true),
		},
